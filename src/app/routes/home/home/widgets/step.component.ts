                                    ...
                                    <div class="px-4 m-auto flex-auto w-1/2">
                                        ...
                                        <div class="relative mb-7.5 md:mb-17">
                                            <div class="pb-0 text-center">
                                                <h3 class="text-[#33d687] uppercase leading-6 font-bold mb-1 inline-block">DIAGNOSTIC STAGES</h3>
                                                <h2 class="text-2xl md:text-10.8 leading-12.8 font-semibold tracking-0 mb-3 uppercase">Prepare for your health</h2>
                                            </div>
